...
def main():
    ...
    query_five_reducer_worker = QueryFiveReducer(queue_name_origin_eof, queue_name_origin,queues_name_destiny, cant_slaves, is_master, ip_master, port_master, ip_healthchecker, port_healthchecker)
    query_five_reducer_worker.start()
