...
class WorkerReviewValidator(ReviewWorker):
    def __init__(self, queue_name_origin, queues_name_destiny, cant_next, db_games_ip, db_games_port):
        super().__init__(queue_name_origin, queues_name_destiny, cant_next)
        self.db_games_ip = db_games_ip
        self.db_games_port = db_games_port
