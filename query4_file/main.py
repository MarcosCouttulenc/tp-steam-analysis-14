...
def main():
    ...
    query_four_file_worker = QueryFourFile(queue_name_origin, file_path, int(result_query_port), int(listen_backlog), ip_healthchecker, int(port_healthchecker))
    query_four_file_worker.start()
