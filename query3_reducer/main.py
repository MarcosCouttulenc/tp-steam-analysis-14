...
def main():
    ...
    query_three_reducer_worker = QueryThreeReducer(queue_name_origin_eof, queue_name_origin,queues_name_destiny, cant_slaves, is_master, ip_master, port_master, ip_healthchecker, port_healthchecker)
