...
def main():
    ...
    query_five_file_worker = QueryFiveFile(queue_name_origin, file_path, int(result_query_port), int(listen_backlog), ip_healthchecker, int(port_healthchecker))
    query_five_file_worker.start()
