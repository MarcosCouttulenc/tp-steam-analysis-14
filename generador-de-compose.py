...
cantidad_clientes = 1
cantidad_review_validator = 10* cantidad_clientes
cantidad_game_validator = 5 * cantidad_clientes
cantidad_health_checkers = 3
cantidad_query1_file = 3
cantidad_query2_file = 3
cantidad_query3_file = 8
cantidad_query4_file = 8
cantidad_query5_file = 8
cantidad_bdds = 10
