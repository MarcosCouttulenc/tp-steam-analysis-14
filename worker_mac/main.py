...
def initialize_config():
    ...
    try:
        ...
        config_params["master_port"] = os.getenv('PORT_MASTER')
...
def main():
    ...
    master_port = config_params["master_port"]
    ...
    macos_worker = MACOSWorker(queue_name_origin_eof,queue_name_origin, queues_name_destiny, cant_next, cant_slaves,is_master, ip_master, master_port)
    macos_worker.start()
